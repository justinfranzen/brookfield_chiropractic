...
<h1 id="main-header">Legal Disclaimer</h1>
    ...
    <div id="secondary-content">
        ...
        <p>In no event will Brookfield Chiropractic, its related partnerships or corporations, or the partners, agents or employees thereof be liable to you or anyone else for any decision made or action taken in reliance on the information in this Site or for any consequential, special or similar damages, even if advised of the possibility of such damages.</p>
        
        <p>Certain links in this Site connect to other Web Sites maintained by third parties over whom Brookfield Chiropractic has no control. Brookfield Chiropractic makes no representations as to the accuracy or any other aspect of information contained in other Web Sites.</p>
    ...
    <div class="additional-info">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <ul id="links">
                    <li><a href="">Become A Practice Member</a></li>
                    <li><a href="">Who We Help</a></li>
                    <li><a href="">Subluxations</a></li>
                    <li><a href="">Adjustments</a></li>
                    <li><a href="">Common Myths</a></li>
                    <li><a href="">Practice Newsletter</a></li>
